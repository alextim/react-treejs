...
const CircularProgressBar = ({
  ...
  inactiveStrokeColor = inactiveStrokeColor ?? defaultProps.inactiveStrokeColor;
  backgroundColor = backgroundColor ?? defaultProps.backgroundColor;
  textColor = textColor ?? defaultProps.textColor;
  labelFontSize = labelFontSize ?? defaultProps.labelFontSize;
  valueFontSize = valueFontSize ?? defaultProps.valueFontSize;
  withGradient = withGradient ?? defaultProps.withGradient;
  anticlockwise = anticlockwise ?? defaultProps.anticlockwise;
  initialAngularDisplacement = initialAngularDisplacement ?? defaultProps.initialAngularDisplacement;
